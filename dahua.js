...
dahua.prototype.connect = function(options) {
    ...
    var opts = { 
      'url' : BASEURI + '/cgi-bin/eventManager.cgi?action=attach&codes=[VideoMotion,VideoBlind,VideoAbnormalDetection,SceneChange,CrossLineDetection,CrossRegionDetection,LeftDetection,SceneChange,TakenAwayDetection,FaceDetection,RioterDetection,MoveDetection,WanderDetection,CrossFenceDetection,ParkingDetection,NumberStat,RetrogradeDetection,TrafficJunction]',
      'forever' : true,
